...
{/*----------------------------------------------------------------------------------------------------------------- */}
 ...
 <Row>
        ...
        <FormGroup>
         ...
         {/*----------------------------------------------------------------------------------------------------------------- */}
        <FormGroup>
          <ControlLabel>Favorite music</ControlLabel>
            <Checkbox value = "anime music" checked = {this.state.music.indexOf('anime music')>=0 ? true:false} onChange = {this.checkboxChange('music')}>anime music</Checkbox>
            <Checkbox value = "pop music" checked = {this.state.music.indexOf('pop music')>=0 ? true:false} onChange = {this.checkboxChange('music')}>pop music</Checkbox>
            <Checkbox value = "kpop music" checked = {this.state.music.indexOf('kpop music')>=0 ? true:false} onChange = {this.checkboxChange('music')}>kpop music</Checkbox>
            <Checkbox value = "filipino music" checked = {this.state.music.indexOf('filipino music')>=0 ? true:false} onChange = {this.checkboxChange('music')}>filipino music</Checkbox>
        ...
        <FormGroup>
          <ControlLabel>status</ControlLabel>
            ...
            <Radio name = "status" value="married" onChange={this.onChange('status')}>married</Radio>
         ...
         {/*----------------------------------------------------------------------------------------------------------------- */}
          ...
          Your favorite music is/are <strong>{
